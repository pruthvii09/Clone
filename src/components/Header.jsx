          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-fit-content bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0 "
              >
                {user && user.email === "autipruthviraj@gmail.com" && (
                  <Link to={"/createItem"}>
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                <li className="text-base px-4 py-2 hover:bg-slate-100 text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                  Home
                </li>
                <li className="text-base px-4 py-2 hover:bg-slate-100 text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                  Menu
